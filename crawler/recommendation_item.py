...
class RecommendationItem:
    ...
    out_cols = [
        ...
        'reason_out', 'out_adj_price', 'accu_rtn', 'out_dt_crawl'
    ]
    param = {
        'startDt': '20190107',
        'endDt': '20190207',
    ...
    def crawl_daily_item(self, from_date, to_date):
        ...
        while True:
            ...
            in_df = self.__crawl(curr, proc=1)
            # out_df = self.__crawl(curr, proc=2)
            i += 1
        return in_df
